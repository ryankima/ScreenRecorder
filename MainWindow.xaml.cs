...

{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void CreateVideo(object sender, RoutedEventArgs e)
        {
            refresh.Stop();
            refresh.Dispose();
            var images = Directory.GetFiles(System.Windows.Forms.Application.StartupPath +"\\Temp\\");
            Array.Sort(images);
            using (var vFWriter = new VideoFileWriter())
            {
                ...
                {
                    using (Stream bmpStream = System.IO.File.Open(imagePath, System.IO.FileMode.Open))
                    {
